...
Task#N Step[i]: [步骤描述]
证据等级: L1-L5（复用 verification.md）

### 现象复述
- [精炼后的异常现象描述，去除噪声]

### 根因假设（按证据等级排序）
1. [假设 A] — 证据: [L1 具体引用 / L2 推断链 / L4 表面观察] — 验证需求: [需要验证什么]
2. [假设 B] — 证据: [L1 具体引用 / L2 推断链 / L4 表面观察] — 验证需求: [需要验证什么]
3. [假设 C] — 证据: [L1 具体引用 / L2 推断链 / L4 表面观察] — 验证需求: [需要验证什么]
