...
version: "1.0"
type: product
description: "产品思维协作——先识别问题类型与不确定性，再进入诊断/创始人/构建器模式，用高判别问题逼出真实前提、红旗信号与下一步动作"
triggers:
  - "这个方向靠谱吗 / 值不值得做 / 你觉得行不行"
  - "这个需求是真的吗 / 用户真的有这问题吗 / 会不会是伪需求"
  - "帮我想想 MVP 怎么砍 / 先做什么后做什么 / 最小验证是什么"
  - "这个产品哪里有问题 / 为什么没增长 / 方案评审"
  - "用户说 产品思维、方向判断、灵魂三问、JTBD、MVP、逆向思维、诊断、创始人、构建者"
keywords:
  - "产品思维"
  - "方向判断"
  - "需求诊断"
...
不要只复述用户原话，也不要把所有可能性平铺罗列。必须明确指出：
...
每轮结尾都尽量给出一个最小行动作业 + 验证信号（成功/失败），避免只停在启发层。
