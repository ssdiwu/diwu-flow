...
version: "1.0"
type: product
description: "产品需求分析方法论——竞品分析、用户画像、需求优先级排序、迭代层次设计、方案对比、非功能性需求分类"
triggers:
  - "讨论产品规划或功能设计"
  - "进行需求分析或竞品调研"
  - "设计迭代路径或优先级排序"
...
每条 Layer 0 对应一行。名称用 kebab-case，直接作为输入参数。
...
> 方案对比、五维约束发现、非功能性需求分类、双端落地 checklist 等深度设计方法已统一归入 `skills/ddoc/SKILL.md` §正向模式（需求→文档）。dprd 聚焦产品论证（脊梁论证、竞品分析、迭代层次），技术方案部分交给 ddoc 正向模式完成。
